...
package com.google.sample.junk.apis;
...
import com.google.sample.junk.utils.EndpointUtil;
import com.google.sample.junk.utils.PlacesHelper;
import com.google.sample.junk.Constants;
...
public class PlaceEndpoint {
    ...
    public final List<PlaceInfo> getPlaces(
            @Named("longitude") final String longitudeString,
        ...
        LOG.log(Level.INFO, "lat:"+latitudeString + ", lon:" + longitudeString);
